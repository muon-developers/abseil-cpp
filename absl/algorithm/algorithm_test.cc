...
TEST_F(LinearSearchTest, linear_search_2) {
  EXPECT_TRUE(absl::linear_search_2(container_.begin(), container_.end(), 3));
  EXPECT_FALSE(absl::linear_search_2(container_.begin(), container_.end(), 4));
}
